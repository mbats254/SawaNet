...
//teacher routes
Route::get('/set/subjects', 'SchoolController@set_subjects')->name('set.subjects');
Route::post('/select/subject/post', 'SchoolController@subject_teacher_post')->name('select.subject.post');
