            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.subscription') }}">
                            <i class="fa fa-user text-primary"></i> {{ __('Customer Subscriptions') }}
                        </a>
                </li>
                @if(Auth::user()->admin->status == 1)
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('add.new.admin') }}">
                        <i class="fa fa-plus text-primary"></i> {{ __('Add New Admin') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('all.admins') }}">
                        <i class="fa fa-plus text-primary"></i> {{ __('All Admins') }}
                    </a>
                </li>
