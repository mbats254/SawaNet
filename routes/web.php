...
Route::get('/upgrade/package/{uniqid}', 'AdminController@upgrade_package')->name('upgrade.package');
Route::post('/upgrade/package/post', 'AdminController@upgrade_package_post')->name('upgrade.customer.package');
Route::post('/post/new/admin', 'AdminController@post_new_admin')->name('post.new.admin');
Route::get('/add/new/admin', 'AdminController@add_new_admin')->name('add.new.admin');
Route::get('/all/admins', 'AdminController@all_admins')->name('all.admins');
Route::get('/remove/admins/{id}', 'AdminController@remove_admin')->name('remove.admin');
